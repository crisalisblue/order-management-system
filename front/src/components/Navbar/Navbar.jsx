...
export const NavBar = () => {
  ...
  return (
    <nav className={" h-full flex flex-col justify-between py-0"}>
      <div className={""}>
        <button className={"flex h-[50px] px-[20px]"}>
          <svg
      ...
      <ul className={"flex flex-col justify-evenly px-[20px] h-full"}>
        <li className={"my-2"}>
          <RouterLink
            className={"w-full h-full flex cursor-context-menu items-center"}
            to="/home"
          >
            <svg
              className={"h-[30px] p-0 mr-5 cursor-pointer"}
              viewBox="0 0 24 24"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <li className={"my-2"}>
          ...
          >
            ...
            <span className={"cursor-pointer"}>Pedidos</span>
          </RouterLink>
        </li>
        <li className={"my-2"}>
          <RouterLink
        ...
        <li className={"my-3"}>
          ...
          >
            ...
            <span className={"cursor-pointer"}>Impuestos</span>
          </RouterLink>
        </li>
        <li className={"my-3"}>
          <RouterLink
          ...
          >
            ...
            <span className={"cursor-pointer"}>Usuarios</span>
          </RouterLink>
        </li>
        <li className={"my-3"}>
          <RouterLink
