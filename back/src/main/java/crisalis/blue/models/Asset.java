...
public abstract class Asset {
    ...
    @JoinTable(name = "Asset_Tax", joinColumns = @JoinColumn(name = "id_asset", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "id_tax", referencedColumnName = "id"))
